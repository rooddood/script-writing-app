    ...
    const loadModel = async () => {
        ...
        try {
            ...
            try {
                ...
                console.log("[DEBUG] Model JSON data:", data);

                // Process the JSON data to load the model
                const pipelineInstance = await pipeline('text-generation', data);
  ...
  const handleCustomCommand = async () => {
    ...
    try {
        ...
        if (!output || output.length === 0) {
            ...
            alert("No output generated. Please try again.");
            return;
        }
